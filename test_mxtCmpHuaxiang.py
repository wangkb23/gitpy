...
class test_mxtHuax(unittest.TestCase):
    def setUp(self):
        getData()
...
#        print dt
    ...
    def test_mxtHuax(self):
        ...
        self.assertGreaterEqual(len(dataAll),6,u'企业画像-区域分析数据返回较少,之前是65条,现在为: '+str(len(dataAll))+" "+recontent.url)
