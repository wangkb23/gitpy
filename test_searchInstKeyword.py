...
class test_keyInst(unittest.TestCase):
    def setUp(self):
    	getData()
...
#        print dt
    ...
    def test_instNum(self):
        ...
        self.assertGreaterEqual(int(compNum),237,u'机构搜索关键字-金融-机构数量少于预期值237,本次结果为: '+str(compNum)+" "+recontent.url)
